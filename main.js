...
let row = document.querySelector('.yotube_items_sections .currentYouTube')
...
let searchInput = document.querySelector('.yotube_items_sections .searchInput')
